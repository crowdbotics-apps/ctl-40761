"""
Django settings for ctl_40761 project.
...
WSGI_APPLICATION = 'ctl_40761.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ctl_40761 API",
    "DESCRIPTION": "API documentation for ctl_40761 App",
    "VERSION": "v1",
}
